...
In this step we are taking the premise and the hypothesis and combining them as a sentence pair [**premise**, **hypothesis**], this sentence pair is fed into the model tokenizer to get the input ids.
